...
# extra crap for Sugar that needs setting before we go fullscreen
echo Sugar Bundle ID is [sim SugarBundleId]
wm sugarbundleid $win [sim SugarBundleId]
echo Sugar Activity ID is [sim SugarActivityId]
wm sugaractivityid $win [sim SugarActivityId]
wm netwmname $win "Micropolis"
# end of extra crap for Sugar
